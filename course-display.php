    ...
    if($class->num_rows > 0) {
        if($position == 1){ /*Hien thi o sidebar*/
            ...
            <div class='cell border border-muted mb-3'>
                    ...
                    <div class='cell-option bg-light dropdown-menu' aria-labelledby='dropdownMenuButton'>
                        <div class='cell-option-list dropdown-item'>
                            ...
                            <input name='delete-code' value='".$row['class_code']."'>
                                ...
                                <button type='button' class='cell-option-list-item btn delete-class' data-toggle='modal' data-target='"."#i".$row['class_code']."i'>Delete class</button>
                        </div>
                    </div>
                ...
                echo "<div class='modal fade' id='i".$row['class_code']."i' tabindex='-1' role='dialog' aria-labelledby='delete-class-confirm' aria-hidden='true'>
    <div class='modal-dialog modal-dialog-centered' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                Are you sure want to delete ".$row['course_name']."?
            </div>
            <div class='modal-footer'>
                <button type='button' class='btn btn-secondary' data-dismiss='modal'>Cancel</button>
                <button type='submit' class='btn btn-primary' form='".$row['class_code']."'>Proceed</button>
            </div>
        </div>
    </div>
</div>";
